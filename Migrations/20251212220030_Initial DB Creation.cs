        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultFiness = table.Column<int>(type: "integer", nullable: false, defaultValue: 999)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    House = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightDirty = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
                    WeightClean = table.Column<decimal>(type: "numeric(6,2)", nullable: true),
                    Fineness = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "MetalTypes",
                columns: new[] { "Id", "DefaultFiness", "Name" },
                values: new object[,]
                {
                    { 1, 585, "Золото" },
                    { 2, 925, "Серебро" },
